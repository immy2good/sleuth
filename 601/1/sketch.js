/*
Officer: 7315287
CaseNum: 601-1-28046335-7315287
...
where she was last seen. Do this by drawing small, FireBrick fill ellipses at each location.
...
var Casey_Data_Coordinate_X = [639, 681, 712, 756, 715, 701, 753, 815, 795, 788, 781, 768, 750, 732, 714, 695, 693, 654, 624, 594, 555];
var Casey_Data_Coordinate_Y = [288, 286, 293, 310, 368, 425, 436, 468, 506, 497, 486, 489, 500, 506, 514, 531, 552, 523, 500, 484, 474];
...
function setup()
{
  ...
  noStroke()
  fill(178,34,34)
  for (var i = 0 ; i < Casey_Data_Coordinate_X.length; i++) {
    ellipse(Casey_Data_Coordinate_X[i], Casey_Data_Coordinate_Y[i], 5)
  }
  
  noFill()
  stroke(255,140,0)
  for (var i = 0 ; i < Crime_Data.length; i ++) {
    rect(Crime_Data[i].pointX-2.5, Crime_Data[i].pointY-2.5, 5, 5)
    console.log(Crime_Data[i].pointX, Crime_Data[i].pointY);
  }
//   for (var i = 0 ; i < Crime_Data.length; i ++) {
  
//   ellipse(Crime_Data[i].pointX, Crime_Data[i].pointY, 5)
//   console.log(Crime_Data[i].pointX, Crime_Data[i].pointY);
// }
//   noStroke()
