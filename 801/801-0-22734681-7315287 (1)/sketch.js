...
function draw()
{
	...
	theatregoers[1][0].caught = true;
	theatregoers[0][4].caught = true;
	theatregoers[3][2].caught = true;
	theatregoers[5][8].caught = true;
	theatregoers[7][6].caught = true;
	// theatregoers[8][0].caught = true;
	theatregoers[8][8].caught = true;
	theatregoers[9][0].caught = true;
